...
describe('RegistrationForm', () => {
  ...
  it('should mark required fields with aria-required', () => {
    render(<RegistrationForm />);
    expect(screen.getByLabelText(/first name/i).getAttribute('aria-required')).toBe('true');
    expect(screen.getByLabelText(/^email/i).getAttribute('aria-required')).toBe('true');
    expect(document.getElementById('password')?.getAttribute('aria-required')).toBe('true');
    expect(screen.getByLabelText(/gender/i).getAttribute('aria-required')).toBe('true');
  });
