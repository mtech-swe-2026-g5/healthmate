...
vi.mock('@/components/ui/AppCalendar', () => ({
  default: vi.fn(({ events, onRangeChange, onEventSelect, isLoading, className }) => (
    <div data-testid="app-calendar-mock" className={className}>
      ...
      <button
        ...
        onClick={() => onEventSelect({ id: 'non-existent-id', title: 'Unknown', start: new Date(), end: new Date() })}
      >
...
vi.mock('@/features/doctor/appointments/components/AppointmentModel', () => ({
  default: vi.fn(({ patient, isModelOpen, onClose }) => (
    <div data-testid="appointment-model-mock">
      ...
      {patient && <div data-testid="model-patient">{patient.firstName} {patient.lastName}</div>}
